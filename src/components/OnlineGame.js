        ...
        <Grid centered>
          <Grid.Row>
            <Menu stackable size={'massive'} inverted items={[
              ...
              game && game.finished ? {key: 'openings-database', icon: 'database', content: 'See in openings DB', color: 'green', active: true, as: 'a',
                href: `/openings-database?position=${(selectedGame || gameGame).compressedFullNotation}`,
